...
public class ShieldGunCore extends CoreItem {
    public static final int BASE_DURATION = 36000;
    public static final int BASE_AMPLIFIER = 9;

    public ShieldGunCore(Item.Properties pProperties, CoreProperties properties) {
